...
export default function SummaryBar({ report }: { report: ComplianceReport }) {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 px-6 py-4 sm:px-8 sm:grid-cols-4" role="region" aria-label="Gap summary">
      <div
